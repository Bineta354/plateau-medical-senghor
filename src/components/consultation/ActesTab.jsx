                  ...
                  <div className="text-right ml-4">
                    ...
                    <div className="mt-1">
                      <span className="text-xs text-gray-500 block">
                        {formatMontantDecimal(parseFloat(acte.tarif_unitaire || 0))} × {acte.quantite}
                      </span>
                      <span className="text-lg font-bold text-purple-600">
                        {formatMontantDecimal(parseFloat(acte.montant_total || (acte.tarif_unitaire * acte.quantite) || 0))}
                      </span>
                    </div>
                  </div>
                </div>
            ...
            <div className="mt-4 p-4 bg-purple-50 rounded-lg border-2 border-purple-200">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xl font-bold text-purple-600">
                  {formatMontantDecimal(actes.reduce((sum, acte) => sum + parseFloat(acte.montant_total || (acte.tarif_unitaire * acte.quantite) || 0), 0))}
                </span>
              </div>
            </div>
          </div>
