                ...
                {data.length === 0 ? (
                  ...
                  data.map((row, index) => (
                    <tr key={`${row.date_session}-${row.caissier_nom || 'na'}-${index}`} className="hover:bg-gray-50">
                      ...
                      <td className="px-4 py-3 text-right font-medium">{formatMontant(row.fond_caisse || 0)}</td>
                      <td className="px-4 py-3 text-right font-medium">{formatMontant(row.montant_journalier || 0)}</td>
                      <td className="px-4 py-3 text-right font-medium">{formatMontant(row.solde_final || 0)}</td>
